...
```
curl -L "http://lprincewhn.github.io/assets/images/k8s-v1.11.2/cni-plugins-amd64-v0.6.0.tgz" | tar -C /opt/cni/bin -xz
```
### 2.2 安装CRICTL
```
...
```
curl -L "http://lprincewhn.github.io/assets/images/k8s-v1.11.2/crictl-v1.11.1-linux-amd64.tar.gz" | tar -C /opt/bin -xz
```
...
# RELEASE=v1.11.2
# cd /opt/bin
# curl -L --remote-name-all http://lprincewhn.github.io/assets/images/k8s-${RELEASE}/{kubeadm,kubectl,kubelet}
